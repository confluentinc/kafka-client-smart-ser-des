---
title: Java Kafka Consumer with Confluent Deserializer Documentation
tableOfContents:
  maxHeadingLevel: 4
---
...
```groovy
implementation 'io.confluent.confluent:kafka-client-smart-deserializer:{deserializer-version}'
