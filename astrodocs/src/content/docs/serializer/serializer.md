---
title: Java Kafka Producer With Confluent Serializer Documentation
tableOfContents:
  maxHeadingLevel: 4
---

This documentation provides a guide on how to use the Java Kafka Producer to send messages to Apache Kafka® topics.
...
```groovy
implementation 'io.confluent.confluent:kafka-client-smart-serializer:{serializer-version}'
