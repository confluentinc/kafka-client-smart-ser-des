...
public class EmployeeAvro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
     ...
     */
    public EmployeeAvro(String ID, String Name, String Email, Integer Age, Integer SSN) {
        this.ID = ID;
        this.Name = Name;
        this.Email = Email;
        this.Age = Age;
     ...
     */
    public static confluent.client.serializer.record.EmployeeAvro.Builder newBuilder() {
        return new confluent.client.serializer.record.EmployeeAvro.Builder();
    }
     ...
     * @return A new EmployeeAvro RecordBuilder
     */
    public static confluent.client.serializer.record.EmployeeAvro.Builder newBuilder(confluent.client.serializer.record.EmployeeAvro.Builder other) {
        if (other == null) {
            return new confluent.client.serializer.record.EmployeeAvro.Builder();
        } else {
            return new confluent.client.serializer.record.EmployeeAvro.Builder(other);
        }
    }
     ...
     * @return A new EmployeeAvro RecordBuilder
     */
    public static confluent.client.serializer.record.EmployeeAvro.Builder newBuilder(confluent.client.serializer.record.EmployeeAvro other) {
        if (other == null) {
            return new confluent.client.serializer.record.EmployeeAvro.Builder();
        } else {
            return new confluent.client.serializer.record.EmployeeAvro.Builder(other);
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EmployeeAvro>
         ...
         * @param other The existing Builder to copy.
         */
        private Builder(confluent.client.serializer.record.EmployeeAvro.Builder other) {
            super(other);
         ...
         * @param other The existing instance to copy.
         */
        private Builder(confluent.client.serializer.record.EmployeeAvro other) {
            super(SCHEMA$, MODEL$);
            if (isValidValue(fields()[0], other.ID)) {
                this.ID = data().deepCopy(fields()[0].schema(), other.ID);
         ...
         * @return This builder.
         */
        public confluent.client.serializer.record.EmployeeAvro.Builder setID(String value) {
         ...
         * @return This builder.
         */
        public confluent.client.serializer.record.EmployeeAvro.Builder clearID() {
            ID = null;
         ...
         * @return This builder.
         */
        public confluent.client.serializer.record.EmployeeAvro.Builder setName(String value) {
         ...
         * @return This builder.
         */
        public confluent.client.serializer.record.EmployeeAvro.Builder clearName() {
            Name = null;
         ...
         * @return This builder.
         */
        public confluent.client.serializer.record.EmployeeAvro.Builder setEmail(String value) {
         ...
         * @return This builder.
         */
        public confluent.client.serializer.record.EmployeeAvro.Builder clearEmail() {
            Email = null;
         ...
         * @return This builder.
         */
        public confluent.client.serializer.record.EmployeeAvro.Builder setAge(int value) {
         ...
         * @return This builder.
         */
        public confluent.client.serializer.record.EmployeeAvro.Builder clearAge() {
         ...
         * @return This builder.
         */
        public confluent.client.serializer.record.EmployeeAvro.Builder setSSN(int value) {
         ...
         * @return This builder.
         */
        public confluent.client.serializer.record.EmployeeAvro.Builder clearSSN() {
        ...
        public EmployeeAvro build() {
            try {
                ...
                record.SSN = fieldSetFlags()[4] ? this.SSN : (Integer) defaultValue(fields()[4]);
                return record;
