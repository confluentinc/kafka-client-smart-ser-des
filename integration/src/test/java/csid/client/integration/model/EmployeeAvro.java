...
public class EmployeeAvro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static csid.client.integration.model.EmployeeAvro.Builder newBuilder() {
    return new csid.client.integration.model.EmployeeAvro.Builder();
  }
   ...
   * @return A new EmployeeAvro RecordBuilder
   */
  public static csid.client.integration.model.EmployeeAvro.Builder newBuilder(csid.client.integration.model.EmployeeAvro.Builder other) {
    if (other == null) {
      return new csid.client.integration.model.EmployeeAvro.Builder();
    } else {
      return new csid.client.integration.model.EmployeeAvro.Builder(other);
    }
  }
   ...
   * @return A new EmployeeAvro RecordBuilder
   */
  public static csid.client.integration.model.EmployeeAvro.Builder newBuilder(csid.client.integration.model.EmployeeAvro other) {
    if (other == null) {
      return new csid.client.integration.model.EmployeeAvro.Builder();
    } else {
      return new csid.client.integration.model.EmployeeAvro.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EmployeeAvro>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(csid.client.integration.model.EmployeeAvro.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(csid.client.integration.model.EmployeeAvro other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.ID)) {
        this.ID = data().deepCopy(fields()[0].schema(), other.ID);
    ...
    /**
      ...
      * @return This builder.
      */
    public csid.client.integration.model.EmployeeAvro.Builder setID(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public csid.client.integration.model.EmployeeAvro.Builder clearID() {
      ID = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public csid.client.integration.model.EmployeeAvro.Builder setName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public csid.client.integration.model.EmployeeAvro.Builder clearName() {
      Name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public csid.client.integration.model.EmployeeAvro.Builder setEmail(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public csid.client.integration.model.EmployeeAvro.Builder clearEmail() {
      Email = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public csid.client.integration.model.EmployeeAvro.Builder setAge(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public csid.client.integration.model.EmployeeAvro.Builder clearAge() {
    ...
    /**
      ...
      * @return This builder.
      */
    public csid.client.integration.model.EmployeeAvro.Builder setSSN(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public csid.client.integration.model.EmployeeAvro.Builder clearSSN() {
